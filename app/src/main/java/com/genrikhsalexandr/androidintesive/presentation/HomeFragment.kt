...
import com.genrikhsalexandr.androidintesive.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toContacts.setOnClickListener {
            toContacts()

        }
        binding.toCountry.setOnClickListener {
            toCountry()
        }
    }
